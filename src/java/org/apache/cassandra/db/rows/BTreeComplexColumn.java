...
public class BTreeComplexColumn extends ComplexColumnData
{
    ...
    private static final long EMPTY_SIZE = ObjectSizes.measure(new BTreeComplexColumn(ColumnMetadata.regularColumn("", "", "", SetType.getInstance(ByteType.instance, true)), NO_CELLS, new DeletionTime(0, 0)));
    ...
    public BTreeComplexColumn purge(DeletionPurger purger, int nowInSec)
    {
